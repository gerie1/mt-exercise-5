...
model_name=transformer_model_bpe_2k
...
CUDA_VISIBLE_DEVICES=$device OMP_NUM_THREADS=$num_threads python -m joeynmt translate $configs/$model_name.yaml < $data/test.de-en-tokenized-bpe-2k.$src > $translations_sub/test.de-en-tokenized-bpe-2k.$model_name.$trg
